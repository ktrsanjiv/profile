...
<html>
    <head>
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=UA-138490527-1"></script>
        <script>
          window.dataLayer = window.dataLayer || [];
          function gtag(){dataLayer.push(arguments);}
          gtag('js', new Date());

          gtag('config', 'UA-138490527-1');
        </script>

        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <link rel="shortcut icon" href="img/Profile_pic.jpg">
        <title>Sanjiv Kumar</title>
            ...
            <div id="main-nav" class="collapse navbar-collapse">
                <nav>
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="#featured">Skills and Proficiency</a></li>
                        <!-- <li><a href="#acad">Education</a></li> -->
                        <li><a href="#video">Work Experience</a></li>
                        <li><a href="#blog">Academics & Projects</a></li>
        ...
        <div class="page-content">
            <section id="featured" class="content-section">
                <div class="section-heading">
                    <h1>Technology<br><em>Stack</em></h1>
                    <p>Software Engineer.
                </div>
            ...
            <section class="footer">
                <p>Copyright &copy; 2019 Sanjiv Kumar</p>
            </section>
        </div>
